...
describe('Schedule page tests', () => {
    ...
    it('shows graph and price/emission when preferences are filled in - Balanced Mode', () => {
        // Skip setting time
        // Set energy to 50 kWh
        cy.react("EnergySelector").react("StyledSlider").type(50000)
    ...
    it('shows graph and price/emission when preferences are filled in - Fast Mode', () => {
        // Skip setting time
        // Set energy to 50 kWh
        cy.react("EnergySelector").react("StyledSlider").type(50000)
